...
import { useEditUserPage } from '@/hooks/admin/consultants/useEditUserPage';
import { Role, User } from '@/lib/interfaces';
import { motion } from 'framer-motion';
import { AlertCircle, ArrowLeft, CheckCircle, Globe, Loader2, Phone, Save, Shield, User as UserIcon, X } from 'lucide-react';
...
export function EditUserForm({ formData, setFormData, saving, success, onSubmit }: EditUserFormProps) {
  return (
    ...
    >
      <div>
         <ConsultantCard practitioner={formData as User}  />   
      ...
      <div className="flex gap-3 border-t border-slate-200 pt-4 dark:border-[color:var(--theme-border)]">
        <CacheLink
          href={`/admin/consultants?r=${Date.now()}`}
